  ...
  pt: {
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        "No formulário de contato, podemos coletar nome, e-mail, telefone, empresa, área de interesse, origem da visita e parâmetros de campanha. O envio ocorre somente após a autorização apresentada no próprio formulário.",
        "Os dados do formulário podem ser processados no SendPulse, utilizado pela TironiTech para organizar contatos e comunicações autorizadas. O SendPulse atua como fornecedor de tecnologia e não recebe autorização para vender essas informações.",
        "O titular pode solicitar acesso, correção, interrupção das comunicações ou exclusão dos dados pelo e-mail tironi@tironitech.com. Os dados são mantidos somente pelo período necessário para o contato, a relação comercial e o cumprimento de obrigações aplicáveis.",
  ...
  en: {
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        "The contact form may collect name, email address, phone number, company, area of interest, visit source and campaign parameters. Submission occurs only after the authorization displayed in the form.",
        "Form data may be processed by SendPulse, which TironiTech uses to organize contacts and authorized communications. SendPulse acts as a technology provider and is not authorized to sell this information.",
        "The data subject may request access, correction, suspension of communications or deletion by emailing tironi@tironitech.com. Data is retained only as long as needed for the contact, business relationship and applicable obligations.",
  ...
  es: {
    ...
    privacy: {
      ...
      paragraphs: [
        ...
        "El formulario de contacto puede recopilar nombre, correo electrónico, teléfono, empresa, área de interés, origen de la visita y parámetros de campaña. El envío ocurre únicamente después de la autorización mostrada en el formulario.",
        "Los datos del formulario pueden ser procesados por SendPulse, que TironiTech utiliza para organizar contactos y comunicaciones autorizadas. SendPulse actúa como proveedor de tecnología y no está autorizado a vender esta información.",
        "El titular puede solicitar acceso, corrección, interrupción de comunicaciones o eliminación escribiendo a tironi@tironitech.com. Los datos se conservan solo durante el período necesario para el contacto, la relación comercial y las obligaciones aplicables.",
