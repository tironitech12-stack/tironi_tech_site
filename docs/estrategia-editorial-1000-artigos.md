...
A liberação de indexação dos 1.683 artigos existentes foi implementada. O primeiro lote contém 5 novos tutoriais em português, cada um com mais de 12 mil caracteres de corpo, dez etapas, exemplos, FAQ e fontes. Restam 995 artigos da meta de 1.000. Traduções deste lote ainda não foram escritas. As alterações estão locais até publicação.
